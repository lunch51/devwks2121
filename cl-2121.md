...
Time to refine our call to only pull the information needed.  Look through the fields and see what you would like to gather.  I'm going to use something like this:
