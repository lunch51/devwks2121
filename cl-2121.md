...
Hit the file menu and select " and if the folder is not already open, hit
"File", "Open Folder" and navigate to Documents/DEVWKS-2121/PowerShell folder and hit "Open"
